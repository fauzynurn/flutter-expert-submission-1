...
void main() {
  late MockPopularTvSeriesListBloc popularTvSeriesListBloc;

  setUp(() {
    popularTvSeriesListBloc = MockPopularTvSeriesListBloc();
  });

  Widget makeTestableWidget(Widget body) {
    return BlocProvider<PopularTvSeriesListBloc>(
      create: (context) => popularTvSeriesListBloc,
      child: MaterialApp(
        home: body,
      ),
    );
  ...
  //     );
  //
  //     await tester.pumpWidget(_makeTestableWidget(PopularTvSeriessPage()));
  //
  //     await tester.tap(
