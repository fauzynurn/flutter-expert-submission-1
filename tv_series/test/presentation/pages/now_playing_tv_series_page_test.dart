...
void main() {
  late MockNowPlayingTvSeriesListBloc topRatedTvSeriesListBloc;

  setUp(() {
    topRatedTvSeriesListBloc = MockNowPlayingTvSeriesListBloc();
  });

  Widget makeTestableWidget(Widget body) {
    return BlocProvider<NowPlayingTvSeriesListBloc>(
  ...
  //     );
  //
  //     await tester.pumpWidget(_makeTestableWidget(NowPlayingTvSeriessPage()));
  //
  //     await tester.tap(
